...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Project_js__ = __webpack_require__(6);
...
class Form {
  ...
  reset() {
    for (let att in this) {
      if ((this[att] instanceof __WEBPACK_IMPORTED_MODULE_0__Errors_js__["a" /* default */]) === false) {
          this[att] = ''
      }
    }
  }
  ...
  onSubmit() {
    return new Promise((resolve, reject) => {
      ...
      if (hasError === false) {
        resolve(new __WEBPACK_IMPORTED_MODULE_1__Project_js__["a" /* default */](name, description))
      } else {
        reject(errors)
      }
    })
